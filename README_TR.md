...
- **OpenCode Sidebar Eklentisi (YENİ):** Opsiyonel TUI paneli ile hızlı hesap geçişi, kompakt kota görünümü, yenileme kontrolü, auto-refresh anahtarı ve kalıcı arayüz tercihleri sunar.
...
## 🧩 Opsiyonel Sidebar Eklentisi

Bu repoda artık `plugin/oc-hesap-sidebar` altında OpenCode TUI sidebar eklentisi de var.

Sunduğu özellikler:

- Durum rozetli kompakt kota paneli (`OK`, `MID`, `LOW`, `ERR`)
- Cooldown göstergeli manuel yenileme
